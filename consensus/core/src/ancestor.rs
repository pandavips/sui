...
impl AncestorStateManager {
    ...
    /// Calculate the network's low quorum round from authorities by inclusion stake
    /// threshold, where low quorum round is the highest round a block has been seen
    /// by authorities.
